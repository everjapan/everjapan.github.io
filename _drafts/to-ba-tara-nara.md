# 详解日语条件助词「と、ば、たら、なら」用法

之前写过一篇文章专门介绍[「は」与「が」、「に」与「へ」、「より」与「から」用法和区别](https://mp.weixin.qq.com/s/EdNmKyHWVKBpLDVohHDCjw)，阅读量还不小。
...
当「と」用作条件时，不能后接表示「意志、劝诱、命令」的表达。

例句：

> ✅ 学校が終わる **と** 、塾に行く。（习惯）

> ❌ 学校が終わる **と** 、塾に行きましょう。（劝诱）
...
条件「ば」的后面不会跟表示「意志、劝诱、命令」等主观态度的表达。

> ❌ 外に出れ **ば** 、必ずマスクをつけなさい。

但是，有两个例外情况：

①  如果前面的句子是「状态谓语」，那么可以使用意志、劝诱、命令的表达。

状态谓语包括形容词、某些动词、判断词以及「忙しい」「いる」「ある」等词。

*关于这部分知识，后续我会专门写一写，这里暂且略过。*

②  如果前后句子的主语不同，也可以使用意志、劝诱、命令的表达。

例句:

> マスクが売っていれ ば 、いっぱい買おう。（劝诱）
