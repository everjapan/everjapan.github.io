...
「こうして」和「それでは」是两个表示展开类接续词。这两个接续词的共同点是它们都用于展开对话或叙述。它们帮助说话者或作者在已经建立的背景或信息的基础上，顺利地过渡到下一个主题或结论。
...
> ◎ <ruby>日本<rt>にほん</rt></ruby>では<ruby>左側<rt>ひだりがわ</rt></ruby>通行だ。<ruby>これに対して<rt>これにたいして</rt></ruby>、<ruby>アメリカ</ruby>では<ruby>右側<rt>みぎがわ</rt></ruby>通行である。
>
...
> ◎ <ruby>彼<rt>かれ</rt></ruby>は<ruby>長々<rt>ながなが</rt></ruby>と<ruby>説明<rt>せつめい</rt></ruby>したが、<ruby>要するに<rt>ようするに</rt></ruby>、<ruby>助<rt>たす</rt></ruby>けてほしいということだ。
>
> → 他解释了很长时间，简而言之，就是想要帮助。

> ◎ <ruby>彼<rt>かれ</rt></ruby>は<ruby>様々<rt>さまざま</rt></ruby>な<ruby>理由<rt>りゆう</rt></ruby>を挙げたが、<ruby>要するに<rt>ようするに</rt></ruby>、<ruby>仕事<rt>しごと</rt></ruby>を<ruby>辞<rt>や</rt></ruby>めたいのだ。
>
> → 他列举了各种理由，总之，他想辞职。
...
补足（<ruby>補足<rt>ほそく</rt></ruby>）是指添加额外的信息、条件或说明，以完善或限定前面所述的内容。补足接续词用于引入这些附加信息。
...
> ◎ <ruby>この<ruby>サービス</ruby>は<ruby>24時間<rt>にじゅうよじかん</rt></ruby>利用<ruby>可能<rt>かのう</rt></ruby>です。**ただし**、<ruby>システムメンテナンス<ruby>中<rt>ちゅう</rt></ruby>はご利用いただけません。
>
...
> ◎ <ruby>会議<rt>かいぎ</rt></ruby>は<ruby>10時<rt>じゅうじ</rt></ruby>から<ruby>始<rt>はじ</rt></ruby>まります。**なお**、<ruby>資料<rt>しりょう</rt></ruby>は<ruby>当日<rt>とうじつ</rt></ruby>配布<ruby>いたします<rt>い</rt></ruby>。
> 
...
> ◎ <ruby>私<rt>わたし</rt></ruby>は<ruby>早起<rt>はやおき</rt></ruby>をする。**なぜなら**、<ruby>朝<rt>あさ</rt></ruby>の<ruby>時間<rt>じかん</rt></ruby>が<ruby>一日<rt>いちにち</rt></ruby>で<ruby>最も<rt>もっとも</rt></ruby><ruby>生産的<rt>せいさんて
>
> → 我早起。因为早晨是一天中最有生产力的时间。)

> ◎ <ruby>彼<rt>かれ</rt></ruby>は<ruby>突然<rt>とつぜん</rt></ruby>辞職<ruby>じしょく</ruby>した。**それというのも**、<ruby>長年<rt>ながねん</rt></ruby>の<ruby>夢<rt>ゆめ</rt></ruby>だった<ruby>自分<rt>じぶん</rt></ruby>の<ruby>会社<rt>かい
>
> → 他突然辞职了。这是因为他等待已久的创办自己公司的机会终于来临。
...
另外，「接续副词」是指连接在「体言」或「用言」之后，用于构成「接续语」的助词。
